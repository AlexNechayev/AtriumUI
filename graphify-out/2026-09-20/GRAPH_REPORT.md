...
## Summary
- 2378 nodes · 6088 edges · 122 communities (113 shown, 9 thin omitted)
...
Cohesion: 0.06
Nodes (9): Phase 3-4 Product Backlog, Session Follow-ups, AuShellHomeView, customElement, property, query, state, mountChildCard() (+1 more)
...
Cohesion: 0.07
Nodes (15): AuActionCardEditor, customElement, AuClimateCardEditor, customElement, AuFanCardEditor, customElement, AuLightCardEditor, customElement (+7 more)
...
Cohesion: 0.15
Nodes (26): AuCalendarTimezoneMode, HaCalendarEventRaw, buildMonthGrid(), CallServiceWithResponse, compileFilter(), computeFetchWindow(), computeMonthGridWindow(), endOfLocalDay() (+18 more)
...
Cohesion: 0.13
Nodes (19): AuCalendarCardEditor, customElement, HTMLElementTagNameMap, VIEW_KEYS, AuCalendarFullscreenOpenOptions, AuCalendarFullscreenSync, ensureCalendarFullscreenOverlay(), HTMLElementTagNameMap (+11 more)
...
Cohesion: 0.13
Nodes (15): buildRoomTileCardConfig(), childConfigForEntity(), ChildConfigOptions, homeAwareCardConfig(), RoomTileCardConfigInput, HassEntityRegistryEntry, AuHomeEntityConfig, AuHomeRoomConfig (+7 more)
...
Cohesion: 0.24
Nodes (16): actionEntity(), ActionKind, ALLOWED_SERVICE_DOMAINS, BLOCKED_HOMEASSISTANT_SERVICES, defaultDoubleTapAction(), defaultHoldAction(), defaultTapAction(), executeAction() (+8 more)

### Community 25 - "Distribution and HACS Feature"
Cohesion: 0.06
Nodes (39): AuActionCard, customElement, CARDS, ActionCardInternals, makeActionCard(), renderActionCard(), makeCalendarHass(), renderClimateCard() (+31 more)
...
Cohesion: 0.10
Nodes (21): AuBaseCard, hasEntityChanged(), property, state, entityIsOn(), CustomCardEntry, HassArea, HassDevice (+13 more)
...
Cohesion: 0.15
Nodes (4): AuCalendarCard, customElement, state, groupEventsByDay()
...
Cohesion: 0.12
Nodes (15): DragState, HTMLElementTagNameMap, applyGridToLovelaceConfig(), buildPersistedGridConfig(), buildPersistedHomeConfig(), GridPersistItem, AuShellTheme, applyShellSettingsPatch() (+7 more)
...
Cohesion: 0.22
Nodes (11): BulkOffResult, bulkTurnOff(), collectBulkOffTargets(), BULK_OFF_DOMAINS, isEntityActive(), isUnavailable(), UNAVAILABLE_STATES, buildPresenceItems() (+3 more)

### Community 41 - "au-shell-grid"
Cohesion: 0.11
Nodes (18): HTMLElementTagNameMap, SelectorPanel, HTMLElementTagNameMap, AuLightSlider, AuLightSliderVariant, HTMLElementTagNameMap, customElement, property (+10 more)
...
Cohesion: 0.08
Nodes (25): AuFanCard, HTMLElementTagNameMap, customElement, state, AuFanSpeedSelector, customElement, property, state (+17 more)
...
Cohesion: 0.17
Nodes (10): AuDrawerAutomationAction, automationActionConfig(), fetchAutomationRegistry(), isAutomationId(), listShellAutomations(), renderDrawerAutomations(), runDrawerAutomationAction(), stubFromRegistry() (+2 more)
...
Cohesion: 0.16
Nodes (7): AuSwitchCard, customElement, auDebug(), isEntityOffline(), GestureKind, formatSwitchSecondary(), validateSwitchEntity()
...
- **Why does `AuShellHomeView` connect `AuShellHomeView` to `tokens.ts`, `action-card-base.test.ts`, `au-shell-grid`, `bindStopBubble`, `AuHomeEntityConfig`, `Architecture Specification`, `computeDomain`, `HomeAssistant`, `._resolvedFloors`, `resolveAction`, `au-shell-home-view.ts`, `au-room-card-editor.stories.ts`, `Distribution and HACS Feature`, `._placeFloorCard`, `._renderAddEntityModal`, `water-heater-timer.ts`?**
  _High betweenness centrality (0.117) - this node is a cross-community bridge._
- **Why does `HassEntity` connect `action-card-base.test.ts` to `AuShellHomeView`, `light.ts`, `AuActionCardBase`, `home-edit-room-modal.ts`, `AuShellGrid`, `HassEntity`, `computeDomain`, `Distribution and HACS Feature`, `au-vacuum-card.ts`, `._placeFloorCard`, `tokens.ts`, `au-device-card.ts`, `au-shell-grid-home.test.ts`, `Home Tiles`, `AuSensorCard`, `Feature: Card contract`, `AuSensorCard`, `AuSwitchCard`, `Home Tiles`, `displayColumnsForWidth`, `resolveAction`, `resolveAction`, `areas.ts`, `au-vacuum-card-editor.stories.ts`, `._resolvedFloors`, `VacuumSettingsDraft`, `AuSwitchCard`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `lit` connect `AuSensorCard` to `light.ts`, `AuActionCardBase`, `HassEntity`, `computeDomain`, `HomeAssistant`, `au-calendar-card-editor.ts`, `au-vacuum-card.ts`, `au-vacuum-settings-overlay.ts`, `._placeFloorCard`, `tokens.ts`, `au-device-card.ts`, `._renderEntry`, `au-shell-grid`, `au-vacuum-card-editor.ts`, `AuSwitchCard`, `au-cover-card-editor.ts`, `keywords`, `resolveAction`, `areas.ts`, `AuBaseCard`, `isRtlLanguage`, `tokens.stories.ts`, `bindStopBubble`, `Localize`, `._resolvedFloors`?**
